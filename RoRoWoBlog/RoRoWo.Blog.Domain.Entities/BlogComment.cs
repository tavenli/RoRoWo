...
namespace RoRoWo.Blog.Domain.Entities
{
    public partial class BlogComment
    {
        ...
        public virtual Nullable<int> VerifyUserID
        {
            get;
            set;
        }
    
        public virtual string VerifyUserAccount
        {
            get;
            set;
        }
        ...
        {
            if (previousValue != null && previousValue.BlogComment.Contains(this))
            {
            ...
            if (BlogArticle != null)
            {
                if (!BlogArticle.BlogComment.Contains(this))
                {
                    BlogArticle.BlogComment.Add(this);
                }
